...
자산을 가장 쉽게 한 화면으로 통합 관리하는 **자산 운영 시스템**. 혼자든 가족이든 — 공유는 필요할 때만 선별적으로. 자산 관리 자동화에서 출발해 AI 어시스턴트·투자 분석까지 확장 중이며, 한화 디지털혁신 AI 경진대회 출품작이다.
...
### 가계 운영
- **통합 자산 대시보드** — CFO/구성원 모드 전환, 자산 비중 도넛 차트, USD 자산 원화 환산(접속 시 환율 갱신)
