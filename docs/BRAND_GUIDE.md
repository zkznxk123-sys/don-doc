...
> **⚠️ 시각 정체성 전환 (2026-07-07) — Solid Modern.**
> 색·타입·질감·컴포넌트·모드(다크/라이트)·아이콘 등 **시각 정체성은 [`brand-guide-2.0-solid-modern.md`](./brand-guide-2.0-solid-modern.md)가 정본**이다(딥 포레스트+골드, 숫자 히어로). 랜딩·앱 토큰·아이콘 마이그레이션 완료. 이 문서의 §2 북극성·§5 Voice·§9 일부 등 **비(非)시각 섹션은 계속 유효**하되, 색/타이포/모드 관련 서술은 2.0이 우선한다. 두 문서의 단일 병합은 후속 정리. 근거: `03_personal/projects/don-doc/design/identity-exploration-2026-07-07.md`(vault).
