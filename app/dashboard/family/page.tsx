...
const ROLE_META: Record<AppRole, { label: string; badge: string; avatar: string; icon: React.ElementType }> = {
  CFO:    { label: '대표 CFO',  badge: 'bg-warning-soft border-warning text-warning',  avatar: 'bg-warning-soft dark:bg-warning-soft text-warning',  icon: Crown },
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-card rounded-2xl shadow-card dark:border dark:border-border p-6 mb-6">
        ...
        <div className="bg-background rounded-xl border border-border p-4">
          ...
          <p className="text-xs text-muted-foreground/60 mt-3">링크를 받은 사람은 돈독에서 가족에 바로 합류할 수 있어요</p>
        </div>
      </div>
