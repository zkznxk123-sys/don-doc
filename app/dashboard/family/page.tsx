...
const ROLE_META: Record<AppRole, { label: string; badge: string; avatar: string; icon: React.ElementType }> = {
  CFO:    { label: '대표 CFO',  badge: 'bg-amber-500/10 border-amber-500/20 text-amber-400',  avatar: 'bg-amber-100 dark:bg-amber-500/15 text-amber-600 dark:text-amber-400',  icon: Crown },
