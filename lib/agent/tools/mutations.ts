...
/**
 * 거래 쓰기 tool 3개. 모두 본인 거래 또는 CFO + 공유 거래 권한 검사.
 * - moveTransactionsToAccount: accountId 일괄 변경
 * - updateTransactionCategories: 카테고리 일괄 재분류
 * - toggleTransactionExclusion: 통계 제외·예산 제외 토글
 *
 * lib/agent/tools.ts에서 분리 (specs/tools-refactor-plan-20260523 step 7).
 */
export function buildMutationTools(ctx: ToolContext) {
