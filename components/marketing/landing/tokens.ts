 ...
 * - CREAM : 다크 위 본문 텍스트(밝은) → 라이트 위 본문 텍스트(어두운 ink)
 ...
 *
 * 컨트라스트: BG vs CREAM 16:1 (AAA), BG vs CREAM_DIM ~10:1 (AAA),
...
export const FOREST = '#2F5D4F'                  // alias (legacy)
export const CREAM = '#1A1F1E'                   // body text (deep forest ink)
export const CREAM_DIM = 'rgba(26,31,30,0.64)'   // secondary text
export const CREAM_FAINT = 'rgba(26,31,30,0.14)' // border·divider
