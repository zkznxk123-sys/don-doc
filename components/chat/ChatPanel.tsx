        ...
        >
          <div className="flex items-end gap-2">
            <textarea
              ...
              className="flex-1 resize-none rounded-xl border bg-background px-3 py-2 text-sm outline-hidden focus:ring-2 focus:ring-indigo-500/40 disabled:opacity-50"
            />
            <button
              type="submit"
              aria-label="전송"
