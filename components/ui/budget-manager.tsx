    ...
    <div className="bg-card rounded-2xl p-6 border border-border">
      ...
      <div className="bg-muted rounded-xl p-4 mb-5">
        <div className="flex items-center justify-between mb-3">
          ...
          {editingFamily ? (
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground px-2 py-1 rounded-lg border border-border hover:border-ring transition-colors"
            >
        ...
        {familyBudget > 0 ? (
          ...
          <p className="text-xs text-muted-foreground/60">이번 달 가족 전체 예산을 설정해 주세요.</p>
        )}
      </div>
      ...
      <div className="space-y-3">
        {members.map(member => {
          ...
          return (
            <div key={member.id} className="bg-muted/50 rounded-xl p-4 border border-border">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-full bg-accent flex items-center justify-center text-sm font-bold text-foreground/70">
              ...
              {member.budget > 0 ? (
                ...
                <div className="text-xs text-muted-foreground/60">한도가 설정되지 않았습니다</div>
              )}
            </div>
          )
        })}
